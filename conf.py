...
BLOG_AUTHOR = "Kevin King"  # (translatable)
BLOG_TITLE = "WhatCanYouDo"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://shadowcomer.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://shadowcomer.github.io/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "A place to learn from. A place to be inspired by."  # (translatable)
